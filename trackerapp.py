...
  cursor = connect.cursor()
  ...
  cursor.execute('''INSERT INTO expenses (category, amount, date) VALUES (?,?,?)''',(expense_category, expense_amount, expense_date))
  connect.commit()
  print('Expense added')
...
  cursor = connect.cursor()
  ...
  cursor.execute('''INSERT INTO income (category, amount, date) VALUES (?,?,?)''',(income_category, income_amount, income_date))
  connect.commit()
    print('Income added')
...
  cursor = connect.cursor()
  ...
  cursor.execute('''INSERT INTO budget (category_id, budget) VALUES (?,?)''', (category_id,budget))
  connect.commit()
...
  cursor = connect.cursor()
  ...
  cursor.execute('''SELECT budget FROM budget WHERE category_id=?''',(category_id,))
...
  cursor = connect.cursor()
  ...
  cursor.execute('''INSERT INTO goals (goal, goal_amount, current_progress) VALUES (?,?,?)''', (goal,goal_amount,current_progress))
  connect.commit()
